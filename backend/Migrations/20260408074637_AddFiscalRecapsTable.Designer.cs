...
namespace DigitalisationDesTableauxDeBordAPI.Migrations
{
    ...
    [Migration("20260408074637_AddtableauRecapsTable")]
    partial class AddtableauRecapsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalisationDesTableauxDeBordAPI.Models.Bank", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "BNA - Banque Nationale d'Alg?rie",
                        ...
                        new
                        {
                            ...
                            Code = "CPA",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "CPA - Cr?dit Populaire d'Alg?rie",
                            PositionsJson = "{\"City\":{\"X\":50,\"Y\":100,\"Width\":150,\"FontSize\":14,\"Rotation\":0},\"Date\":{\"X\":400,\"Y\":100,\"Width\":150,\"FontSize\":14,\"Rotation\":0},\"Payee\":{\"X\":120,\"Y\":180,\"Width\":400,\"FontSize\":14,\"Rotation\":0},\"AmountInWords\":{\"X\":120,\"Y\":240,\"Width\":500,\"FontSize\":12,\"Rotation\":0},\"AmountInWordsLine2\":null,\"Amount\":{\"X\":450,\"Y\":300,\"Width\":150,\"FontSize\":18,\"Rotation\":0},\"CheckLayout\":null}"
                        },
                        new
                        {
                            ...
                            Code = "BEA",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "BEA - Banque Ext?rieure d'Alg?rie",
                            PositionsJson = "{\"City\":{\"X\":50,\"Y\":100,\"Width\":150,\"FontSize\":14,\"Rotation\":0},\"Date\":{\"X\":400,\"Y\":100,\"Width\":150,\"FontSize\":14,\"Rotation\":0},\"Payee\":{\"X\":120,\"Y\":180,\"Width\":400,\"FontSize\":14,\"Rotation\":0},\"AmountInWords\":{\"X\":120,\"Y\":240,\"Width\":500,\"FontSize\":12,\"Rotation\":0},\"AmountInWordsLine2\":null,\"Amount\":{\"X\":450,\"Y\":300,\"Width\":150,\"FontSize\":18,\"Rotation\":0},\"CheckLayout\":null}"
                        });
                });
            ...
            modelBuilder.Entity("DigitalisationDesTableauxDeBordAPI.Models.tableauFournisseur", b =>
                {
                    ...
                    b.Property<string>("AuthNIF")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("AuthRC")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("DigitalisationDesTableauxDeBordAPI.Models.tableauRecap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalisationDesTableauxDeBordAPI.Models.Region", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "est",
                            VillesJson = "[\"Constantine\", \"Annaba\", \"S?tif\", \"Batna\", \"Guelma\"]"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "ouest",
                            VillesJson = "[\"Oran\", \"Tlemcen\", \"Sidi Bel Abb?s\", \"Mostaganem\", \"Mascara\"]"
                        });
                });
            ...
            modelBuilder.Entity("DigitalisationDesTableauxDeBordAPI.Models.User", b =>
                {
                    ...
                    b.Property<bool>("IsRegionalApprover")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("DigitalisationDesTableauxDeBordAPI.Models.UserBankCalibration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
